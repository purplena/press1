		...
		<div class="post-content-inner">
			<div class="post-meta">
				<div class="post-author">
					<i class="fa fa-user-o"></i> <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>" title="<?php esc_attr(the_author()); ?>" class="author meta-info"><?php esc_html(the_author()); ?></a>
				</div>
				<div class="post-comments">
					<i class="fa fa-comments-o"></i> <a href="#" class="comments"><?php echo esc_html(get_comments_number($post->ID)); ?> <?php esc_html_e('Comments','storepress'); ?></a>
				</div>
			</div>
			<?php
				if ( is_single() ) :
