 ...
 */
function storepress_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function storepress_sanitize_html( $html ) {
 ...
 */
function storepress_sanitize_number_absint( $number, $setting ) {
 ...
 */
function storepress_sanitize_select( $input, $setting ) {
 ...
 */
function storepress_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function storepress_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function storepress_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}