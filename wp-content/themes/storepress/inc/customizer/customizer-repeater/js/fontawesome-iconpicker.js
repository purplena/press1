(function ($) {
    'use strict';
    wp.storepresscustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                storepress_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.storepresscustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.storepresscustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.storepresscustomizerRepeater.iconPickerToggle($(this));
        });
