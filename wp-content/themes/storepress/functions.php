...
function storepress_widgets_init() {
	register_sidebar( array(
		...
		'description' => __( 'The Primary Widget Area', 'storepress' ),
	...
	register_sidebar( array(
		...
		'description' => __( 'Footer Widget 1', 'storepress' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		...
		'description' => __( 'Footer Widget 2', 'storepress' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h4 class="widget-title">',
		'after_title' => '</h4>',
	...
	register_sidebar( array(
		...
		'description' => __( 'Footer Widget 3', 'storepress' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h4 class="widget-title">',
		'after_title' => '</h4>',
	...
	register_sidebar( array(
		...
		'description' => __( 'This Widget area for WooCommerce Widget', 'storepress' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h5 class="widget-title">',
		'after_title' => '</h5>',
